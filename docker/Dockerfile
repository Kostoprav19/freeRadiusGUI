...
# without relying on `dependency:go-offline` (which can fail when a
# transitive is hosted only in a vendor-specific repository).
COPY pom.xml ./
COPY src ./src
