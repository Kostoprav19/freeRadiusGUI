...
public class AccountController {
  ...
  public String deleteAccount(
    ...
    if (accountService.delete(account)) {
      redirectAttributes.addFlashAttribute(
        "msg",
        "Account '" + account.getLogin() + "' successfully deleted."
      );
      redirectAttributes.addFlashAttribute("msgType", "success");
    } else {
      redirectAttributes.addFlashAttribute(
        "msg",
        "Error deleting account '" + account.getLogin() + "'."
      );
  ...
  public String storeAccount(
    ...
    redirectAttributes.addFlashAttribute(
      "msg",
      "Account '" + account.getLogin() + "' successfully saved."
    );
    redirectAttributes.addFlashAttribute("msgType", "success");
    return "redirect:/" + Views.ADMIN;
  }
